...
class CreateTblsalarystructureTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tblsalarystructure', function (Blueprint $table) {
            $table->id('sStructId');
            ...
            $table->date('sStructDate')->nullable();
    ...
    {
        Schema::dropIfExists('tblsalarystructure');
    }
}
