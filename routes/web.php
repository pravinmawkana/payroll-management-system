...
Route::get('/about/{email}', 'App\Http\Controllers\EmailVerificationController@verifyEmail');
// Route::get('/about/{email}', [EmailVerificationController::class, 'verifyEmail']);
