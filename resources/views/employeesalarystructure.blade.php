            ...
            <form id="salaryStructureForm">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="empCode" name="empCode"
                            placeholder="Enter Employee Code" required readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="empName">Employee Name</label>
                        <input type="text" class="form-control" id="empName" name="empName"
                            placeholder="Enter Employee Name" required readonly>
                    </div>

                    <div class="col-md-4">
                        <label for="sStructDate">Salary Strature Effective Date</label>
                        <input type="text" class="form-control date-picker" id="sStructDate" name="sStructDate"
                            placeholder="Enter Slary Structure Effective Date" required readonly>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="form-group col-md-4">
                                Gross Salary <input type="text" value="0" class="form-control" id="GroossSalary"
                                    name="GroossSalary" placeholder="Enter Employee Code" required readonly>
                            </div>
                            <div class="form-group col-md-4">
                                Total Deducation <input type="text" value="0" class="form-control"
                                    id="DeductionSalary" name="DeductionSalary" placeholder="Enter Employee Code" required
                                    readonly>
                            </div>
                            <div class="form-group col-md-4">
                                Net Pay <input type="text" value="0" class="form-control" id="NetSalary"
                                    name="NetSalary" placeholder="Enter Employee Code" required readonly>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function calculation() {
            ...
            var GroossSalary = parseInt(BasicSalary) + parseInt(HouseRentAllowance) + parseInt(ConveyanceAllowance) +
                parseInt(SpecialAllowance) + parseInt(OtherAllowance) + parseInt(Incentive) + parseInt(SpotIncentive) +
                parseInt(LeaveEncashment) + parseInt(CSIIncentive) + parseInt(SpecialBonus) + parseInt(PerformanceBonus) +
                parseInt(Bonus) + parseInt(OtherSalary) + parseInt(ArrearsSalary) + parseInt(ProvidentFund) + parseInt(
                    ESIC) + parseInt(TDS) + parseInt(OtherDeduction) + parseInt(Loan) + parseInt(SalaryAdvance) + parseInt(
                    MobileDeduction) + parseInt(LatePresent) + parseInt(SecurityDeposite) + parseInt(
                    ProfessionalTaxDeduction);

            var DeductionSalary = parseInt(ProvidentFund) + parseInt(ESIC) + parseInt(TDS) + parseInt(OtherDeduction) +
                parseInt(Loan) + parseInt(SalaryAdvance) + parseInt(MobileDeduction) + parseInt(LatePresent) + parseInt(
                    SecurityDeposite) + parseInt(ProfessionalTaxDeduction);
